...
%% \input{mathext-inc}   % \optsup, \ji
%%


%% Elliptic Parameters
\newcommand{\eargdelim} {;\,}
\newcommand{\eargs} [2] {#1 \eargdelim #2}
...
\newcommand{\eK} [2] [0] { \optsup{#1}{\jK} \left(#2\right)}
...
\newlength{\epqheight}
\newlength{\epqlimit}
\settoheight{\epqlimit}{\ensuremath{\eargs{\ji\xi/2+\jK'}{k'}}}
\newsavebox{\epqbox}
...
%% 4. arg: module (k)
\newcommand{\epq} [4] {%
  \savebox{\epqbox}{\ensuremath{\eargs{#3}{#4}}}
...
\newcommand{\ePi} [3] {\ellPi (#1 \eargdelim #2 \eargdelim #3)}
